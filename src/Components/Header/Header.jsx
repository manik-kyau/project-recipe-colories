            ...
            <div className="navbar bg-base-100 px-0">
              <div className="navbar-start">
                <div className="dropdown">
                  ...
                  <ul tabIndex="0" className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 lexend">
                    <li><a>Home</a></li>
                    <li><a>Recipes</a></li>
                    <li><a>About</a></li>
                    <li><a>Search</a></li>
              ...
              <div className="navbar-end space-x-5">
                ...
                <button><img className='lg:hidden' src={search} alt=""/></button>
            ...
            <div className="banner flex justify-center items-center mt-6 lg:mt-12 rounded-3xl h-[550px] p-8">
                <div className='lg:w-5/6 space-y-6 mb-6'>
                    ...
                    <div className='w-[366px] space-x-6 mx-auto'>
                        <button className='text-lg lg:text-xl font-semibold py-2 px-4 rounded-[50px] bg-[#0BE58A] border-2 border-[#0BE58A] lexend'>Explore Now</button>
                        <button className='text-lg lg:text-xl text-white font-semibold py-2 px-4 rounded-[50px] border-2 border-white lexend'>Our Feedback</button>
                    </div>
                </div>
            </div>
        </div>
